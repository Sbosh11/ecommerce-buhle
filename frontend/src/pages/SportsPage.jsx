...
function SportsPage() {
  ...
  const runningCategory = useMemo(() => {
    return categories.find((category) => category.slug === "running");
  }, [categories]);

  const baseProducts = useMemo(() => {
    return products.filter(
      (product) => product.categoryId === runningCategory?.id,
    );
  }, [products, runningCategory]);
